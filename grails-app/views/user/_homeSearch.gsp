...
<div class="row">
    <div class="span6">
        ...
        <p>
            ...
            <g:formRemote class="form-search" update="searchResults" url="[controller: 'coffeeKitty', action: 'search']" name="search">
    ...
    <div class="span6">
        <h2><g:message code="coffeeKitty.view.noKitty.new.title"/></h2>
        <p>
         <g:render template="../coffeeKitty/create" />
    </p>
    </div>
</div>

<g:render template="../coffeeKitty/searchResults"/>